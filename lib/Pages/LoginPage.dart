...
class _LoginPageState extends State<LoginPage> {
          ...
          child: FlatButton(
            onPressed: () {
              if(_formKey.currentState.validate()){
                ...
                // TODO: Check values and navigate to next page
              }
            },
  ...
  Align buildOrText() {
    return Align(
      alignment: Alignment.center,
      child: Text("or log in with", style: TextStyle(fontSize: 12.0, color: Colors.grey),),
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                buildSocialMediaButtons(GroovinMaterialIcons.google, Colors.red),
                SizedBox(width: 20.0),
